...
def estimate_transcription_time(video_duration_seconds, cuda_cores=1024):
    ...
    # Calibrated to 0.80 based on real-world GTX 1650 (4GB) Whisper Medium profiling
    base_rtf = 0.77
    transcription_time = video_duration_seconds * base_rtf
    
    # Calibrated model load time based on actual disk-to-VRAM transfer speeds
    model_load_time = 35 
    total_seconds = transcription_time + model_load_time
